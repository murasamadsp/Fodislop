...
namespace McpUnity.Unity
{
    ...
    public class McpUnitySettings
    {
        ...
        public const int RequestTimeoutMinimum = 15;
        ...
        [Tooltip("Automatically bring Unity Editor to foreground when an MCP request is received. Prevents timeouts when Unity is unfocused.")]
